...
const en: Record<string, string> = {
  ...
  'invite.button': 'Invite them to Kinly',
  'invite.hint': 'Not on Kinly yet? Send them a download link.',
  'invite.message': 'Join me on Kinly — a simple, private way for our family to stay in touch: {link}',

  'requests.title': 'New requests',
  'requests.wantsToChat': 'wants to chat with you',
  'requests.chatBar': '{name} wants to chat with you. Accept to reply.',
  'requests.accept': 'Accept',
  'requests.block': 'Block',
  'requests.blockConfirm': 'Block {name}? They won’t be able to contact you.',
  ...
  'chat.attachTitle': 'Send something',
  'chat.takePhoto': 'Take a photo',
  'chat.choosePhoto': 'Choose a photo',
  'chat.chooseVideo': 'Choose a video',
  'chat.shareLocation': 'Share my location',
  'chat.myLocation': 'My location',
  'chat.openMap': 'Open map',
  'chat.locationDenied': 'Please allow location access to share where you are.',
  'chat.locationError': 'Could not get your location right now. Please try again.',
  ...
  'privacy.quiet': 'Notifications',
  'privacy.quietTitle': 'Quiet hours',
  'privacy.quietHint': 'Silence message notifications at night. Calls still ring.',
  'privacy.quietOn': 'No message alerts {start}–{end}. Calls still ring.',
  ...
  'group.photoError': 'Could not update the group photo. Please try again.',
  'group.admin': 'Admin',
...
const sv: Record<string, string> = {
  ...
  'invite.button': 'Bjud in dem till Kinly',
  'invite.hint': 'Inte på Kinly än? Skicka en nedladdningslänk.',
  'invite.message': 'Gå med mig på Kinly — ett enkelt och privat sätt för vår familj att hålla kontakten: {link}',

  'requests.title': 'Nya förfrågningar',
  'requests.wantsToChat': 'vill chatta med dig',
  'requests.chatBar': '{name} vill chatta med dig. Acceptera för att svara.',
  'requests.accept': 'Acceptera',
  'requests.block': 'Blockera',
  'requests.blockConfirm': 'Blockera {name}? De kommer inte kunna kontakta dig.',
  ...
  'chat.attachTitle': 'Skicka något',
  'chat.takePhoto': 'Ta ett foto',
  'chat.choosePhoto': 'Välj ett foto',
  'chat.chooseVideo': 'Välj en video',
  'chat.shareLocation': 'Dela min plats',
  'chat.myLocation': 'Min plats',
  'chat.openMap': 'Öppna karta',
  'chat.locationDenied': 'Tillåt platsåtkomst för att dela var du är.',
  'chat.locationError': 'Kunde inte hämta din plats just nu. Försök igen.',
  ...
  'privacy.quiet': 'Aviseringar',
  'privacy.quietTitle': 'Tysta timmar',
  'privacy.quietHint': 'Tysta meddelandeaviseringar på natten. Samtal ringer fortfarande.',
  'privacy.quietOn': 'Inga meddelandeaviseringar {start}–{end}. Samtal ringer fortfarande.',
  ...
  'group.changePhoto': 'Byt gruppfoto',
  'group.photoError': 'Kunde inte uppdatera gruppfotot. Försök igen.',
  'group.admin': 'Admin',
